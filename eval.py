...
def test(clip_model_name: str, batch_size: int):
    ...
    ###verb accuracy###
    # test_data = CustomDataset2(label_embedding,vo_dict,train_val_mode='test',template_mode='v')

    ###object accuracy###
    # test_data = CustomDataset2(label_embedding,vo_dict,train_val_mode='test',template_mode='o')
